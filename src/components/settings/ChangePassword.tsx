          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                required={!isGoogle}
                className="w-full rounded-xl border border-white/8 bg-white/5 py-2.5 pl-10 pr-10 text-sm text-white placeholder:text-slate-600 focus:border-indigo-500/60 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all"
              />
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              required
              className={`w-full rounded-xl border py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-slate-600 bg-white/5 focus:outline-none focus:ring-2 transition-all ${
                confirm && next !== confirm
                  ? "border-red-500/40 focus:ring-red-500/20"
                  : "border-white/8 focus:border-indigo-500/60 focus:ring-indigo-500/20"
              }`}
            />
          </div>
        </div>
